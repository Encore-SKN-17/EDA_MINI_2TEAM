...
### 1. 가축 질병과 축산물 가격
- ASF가 발생하면 대체로 돼지고기의 가격이 소폭 하락하거나 정체하는 경향을 보임
- ASF 발생과 직접적인 관련은 없지만 돼지고기 공급 부족 시기에 닭고기, 소고기의 대체 소비가 증가했을 수 있다 -> 일부 ASF 발생 이후, 닭고기와 소고기 가격도 소폭 상승하는 경향
- 반복된 ASF 발생에도 불구하고 2023~2025년 사이에는 돼지고기 가격이 크게 급등하지 않음 -> 방역 정책이 일정 부분 효과를 보였을 가능성 존재
